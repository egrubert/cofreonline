...
INSERT INTO `compartilhamentos` VALUES (1,1,'00923282025','2025-06-14 17:50:10',1,0),(2,5,'847.680.140-89','2025-06-29 16:55:53',1,0),(3,5,'251.040.910-74','2025-06-29 16:56:13',1,1),(4,6,'251.040.910-74','2025-07-11 18:31:39',1,1),(5,2,'864.041.590-07','2025-07-11 18:39:02',1,1),(6,3,'864.041.590-07','2025-07-11 18:44:53',1,1),(7,7,'389.472.920-10','2025-07-11 19:23:39',1,1);
...
CREATE TABLE `logs_atividades` (
  ...
  KEY `usuario_id` (`usuario_id`),
  KEY `documento_id` (`documento_id`),
  CONSTRAINT `logs_atividades_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `logs_atividades_ibfk_2` FOREIGN KEY (`documento_id`) REFERENCES `documentos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `regras_liberacao` VALUES (1,2,'TODOS',NULL,'LIBERADO'),(2,6,'DATA','2025-07-11 18:31:00','LIBERADO'),(3,2,'ALGUNS',NULL,'LIBERADO'),(4,3,'DATA','2025-07-10 18:45:00','LIBERADO'),(5,7,'ALGUNS',NULL,'PENDENTE'),(6,8,'DATA','2025-07-11 21:27:00','PENDENTE');
...
-- Dump completed on 2025-07-13 20:46:07
